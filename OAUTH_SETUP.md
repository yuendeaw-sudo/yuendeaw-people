...
ทำในบัญชี **addgap@gmail.com** (บัญชีเดียวกับ communeed / STAND) — สร้าง project ใหม่ชื่อ **"YuenDeaw Identity"** วางข้างกัน จัดการที่เดียวจบ

> 💡 Google Sign-in **ฟรี ไม่คิดเงิน** ไม่ต้องเปิด billing สำหรับขั้นตอนนี้
> 💡 ใช้ consent แบบ **External** จึงไม่ต้องมี Organization — Gmail ส่วนตัวทำได้

### Step 1 — เข้าบัญชี + สร้าง project ใหม่
1. เข้า **console.cloud.google.com** ด้วย **addgap@gmail.com**
2. แถบบนสุด (ที่เลือก project) → **New Project**
   - **Project name:** `YuenDeaw Identity`
   - **Organization / Location:** No organization (ค่าเริ่มต้น)
   - กด **Create** → รอสักครู่ → สลับไปใช้ project **YuenDeaw Identity**
